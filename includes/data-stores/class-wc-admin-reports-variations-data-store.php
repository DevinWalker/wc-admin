		...
		foreach ( $products_data as $key => $product_data ) {
			...
			if ( $query_args['extended_info'] ) {
				...
				foreach ( $variations as $variation ) {
					if ( $variation['variation_id'] == $product_data['variation_id'] ) {
						$attributes           = $variation['attributes'];
						$formatted_attributes = array();
						foreach ( $attributes as $att_key => $value ) {
							$formatted_key                          = preg_replace( '/(attribute_pa_|attribute_)/', '', $att_key );
							$formatted_attributes[ $formatted_key ] = $value;
						}
						$extended_info['attributes'] = $formatted_attributes;
